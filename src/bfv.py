...
def make_graphs():
    """
    Makes the graphs that are included in the report.
    
    This will require you to have matplotlib installed.
    """
    print("Running experiments and making graphs...")
    
    import matplotlib.pyplot as plt
    
    # Make a graph of the time taken to encrypt/decrypt as a function of $m$.
    ...
    for M in range(10, 2000, 10):
        ...
        print(f"Finished M = {M} in {end - start} seconds.")
    
    plt.title("Time to Encrypt/Decrypt vs. M")
    plt.xlabel("M")
    plt.ylabel("Time (s)")
    plt.plot(m_values, times)
    plt.savefig("graphs/time_vs_m.png")
...
if __name__ == "__main__":
    ...
    # Decode the message
    m_prime_str = "".join([chr(c) for c in m_prime.c])
    
    print("Encoded Message:", m)
    print("Encrypted Message:", c)
    print("Decrypted Message:", m_prime)
    print("Decoded Message:", m_prime_str)
